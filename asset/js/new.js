 ...
 * https://modernizr.com/download/?-backgroundblendmode-bgsizecover-borderimage-canvas-canvastext-cssanimations-csscalc-cssfilters-cssmask-csspositionsticky-cssreflections-cssscrollbar-csstransitions-ellipsis-fullscreen-geolocation-hiddenscroll-indexeddb-inlinesvg-intl-notification-requestanimationframe-touchevents-websockets-atrule-domprefixes-hasevent-mq-prefixed-prefixedcss-prefixedcssvalue-prefixes-setclasses-testallprops-testprop-teststyles !*/
!function(n, t, i) {
    function c(n, t) {
        return typeof n === t
    }
    function vt() {
        ...
        for (var s in a)
            if (a.hasOwnProperty(s)) {
                ...
                for (f = c(n.fn, "function") ? n.fn() : n.fn,
                e = 0; e < i.length; e++)
                    o = i[e],
                    t = o.split("."),
    ...
    function pt() {
        var n = t.body;
        return n || (n = f(y ? "svg" : "body"),
        n.fake = !0),
        n
    }
    function g(n, i, r, u) {
        var o, a, c, v, l = "modernizr", s = f("div"), e = pt();
        if (parseInt(r, 10))
            for (; r--; )
                c = f("div"),
                c.id = u ? u[r] : l + (r + 1),
        ...
        h.style.overflow = v,
        h.offsetHeight) : s.parentNode.removeChild(s),
        !!a
    }
    function wt(n, t) {
        return !!~("" + n).indexOf(t)
    ...
    function bt(t, r) {
        ...
        if ("CSSSupportsRule"in n) {
            for (u = []; f--; )
                u.push("(" + d(t[f]) + ":" + r + ")");
            return u = u.join(" or "),
            g("@supports (" + u + ") { #modernizr { position: absolute; } }", function(n) {
    ...
    function ft(n, t, r, u) {
        ...
        var l, v, s, y, o, p, a;
        if ((u = c(u, "undefined") ? !1 : u,
        !c(r, "undefined")) && (l = bt(n, r),
        !c(l, "undefined")))
            return l;
    ...
    function v(n, t, i, r, u) {
        var f = n.charAt(0).toUpperCase() + n.slice(1)
          , e = (n + " " + tt.join(f + " ") + f).split(" ");
        return c(t, "string") || c(t, "undefined") ? ft(e, t, r, u) : (e = (n + " " + p.join(f + " ") + f).split(" "),
        dt(e, t, i))
    }
    function o(n, t, r) {
        return v(n, i, i, t, r)
    ...
    }, r = function() {}, nt, s, tt, it, st, ht, ct, lt, at, w, rt, e, l, b, k;
    r.prototype = u;
    r = new r;
    r.addTest("geolocation", "geolocation"in navigator);
    r.addTest("notification", function() {
        if (!n.Notification || !n.Notification.requestPermission)
            return !1;
        if ("granted" === n.Notification.permission)
            return !0;
        try {
            new n.Notification("")
        } catch (t) {
    ...
    nt = !1;
    try {
        nt = "WebSocket"in n && 2 === n.WebSocket.CLOSING
    } catch (gt) {}
    r.addTest("websockets", nt);
    s = u._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : ["", ""];
    u._prefixes = s;
    var h = t.documentElement
      , y = "svg" === h.nodeName.toLowerCase()
      , ot = "Moz O ms Webkit"
      , p = u._config.usePrefixes ? ot.toLowerCase().split(" ") : [];
    u._domPrefixes = p;
    tt = u._config.usePrefixes ? ot.split(" ") : [];
    u._cssomPrefixes = tt;
    it = function(t) {
        var u, h = s.length, f = n.CSSRule, r, e, o;
        if ("undefined" == typeof f)
            return i;
        if (!t)
            return !1;
        if (t = t.replace(/^@/, ""),
        u = t.replace(/-/g, "_").toUpperCase() + "_RULE",
        u in f)
            return "@" + t;
        for (r = 0; h > r; r++)
            if (e = s[r],
    ...
    ;
    u.prefixedCSSValue = ht;
    r.addTest("canvas", function() {
        var n = f("canvas");
        return !(!n.getContext || !n.getContext("2d"))
    });
    r.addTest("canvastext", function() {
        return r.canvas === !1 ? !1 : "function" == typeof f("canvas").getContext("2d").fillText
    });
    r.addTest("csscalc", function() {
        var n = "width:"
          , t = f("a");
        return t.style.cssText = n + s.join("calc(10px);" + n),
        !!t.style.length
    });
    r.addTest("csspositionsticky", function() {
        var n = "position:"
          ...
          , r = f("a")
          , i = r.style;
        return i.cssText = n + s.join(t + ";" + n).slice(0, -n.length),
        -1 !== i.position.indexOf(t)
    });
    r.addTest("inlinesvg", function() {
        var n = f("div");
        return n.innerHTML = "<svg/>",
        "http://www.w3.org/2000/svg" == ("undefined" != typeof SVGRect && n.firstChild && n.firstChild.namespaceURI)
    });
    ct = "CSS"in n && "supports"in n.CSS;
    lt = "supportsCSS"in n;
    r.addTest("supports", ct || lt);
    at = function() {
        ...
        : function(t) {
            var i = !1;
            return g("@media " + t + " { #modernizr { position: absolute; } }", function(t) {
    ...
    u.mq = at;
    w = u.testStyles = g;
    r.addTest("hiddenscroll", function() {
        return w("#modernizr {width:100px;height:100px;overflow:scroll}", function(n) {
            return n.offsetWidth === n.clientWidth
        })
    });
    r.addTest("touchevents", function() {
        var i, r;
        return "ontouchstart"in n || n.DocumentTouch && t instanceof DocumentTouch ? i = !0 : (r = ["@media (", s.join("touch-enabled),("), "heartz", ")", "{#modernizr{top:9px;position:absolute}}"].join(""),
        w(r, function(n) {
            i = 9 === n.offsetTop
        })),
        i
    });
    w("#modernizr{overflow: scroll; width: 40px; height: 40px; }#" + s.join("scrollbar{width:0px} #modernizr::").split("#").slice(1).join("#") + "scrollbar{width:0px}", function(n) {
        r.addTest("cssscrollbar", 40 == n.scrollWidth)
    });
    rt = {
        elem: f("modernizr")
    };
    ...
    ;
    u.testAllProps = v;
    l = u.prefixed = function(n, t, i) {
        return 0 === n.indexOf("@") ? it(n) : (-1 != n.indexOf("-") && (n = ut(n)),
        t ? v(n, t, i) : v(n, "pfx"))
    }
    ;
    u.prefixedCSS = function(n) {
        var t = l(n);
        return t && d(t)
    }
    ;
    r.addTest("fullscreen", !(!l("exitFullscreen", t, !1) && !l("cancelFullScreen", t, !1)));
    try {
        b = l("indexedDB", n)
    } catch (gt) {}
    for (r.addTest("indexeddb", !!b),
    b && r.addTest("indexeddb.deletedatabase", "deleteDatabase"in b),
    r.addTest("intl", !!l("Intl", n)),
    r.addTest("requestanimationframe", !!l("requestAnimationFrame", n), {
        aliases: ["raf"]
    }),
    r.addTest("backgroundblendmode", l("backgroundBlendMode", "text")),
    u.testAllProps = o,
    ...
    r.addTest("cssfilters", function() {
        if (r.supports)
            return o("filter", "blur(2px)");
        var n = f("a");
        return n.style.cssText = s.join("filter:blur(2px); "),
        !!n.style.length && (t.documentMode === i || t.documentMode > 9)
    }),
...
(function() {
    ...
    jQuery.fn.live || (jQuery.fn.live = jQuery.fn.on);
    jQuery.fn.andSelf || (jQuery.fn.andSelf = jQuery.fn.addBack)
}
)(window);
